  ...
  <div>
      ...
      <b-container fluid class="mt-4">
                  ...
                  <b-table bordered hover :items="cart" :fields="fields">
                      ...
                      <template v-slot:cell(remove)="data">
                          <b-button 
                            ...
                            variant="danger" class="mr-2">X</b-button>
                      </template>
                      ...
                      <template v-slot:cell(image)="data">
                          <b-col class="text-center">
                              <b-img style="max-width: 5rem;" 
                                :src="require(`@/assets/img/fruit${data.item.id}.jpg`)" 
          ...
          <b-modal 
            ...
            <ul v-for="productFinal in ticket.items" :key="productFinal.id">
            ...
            <h2 class="my-4 text-center">Total: ${{ ticket.valor }}.00</h2>
          </b-modal>
      </b-container>
  </div>
</template>
...
export default {
    ...
    methods: {
        ...
        buy(){
            this.ticket = {items: this.cart, valor: this.total}
